...
const Icon = ({ name, size = 18, stroke = 1.8, className = "" }) => {
  const paths = {
    ...
    heart: <path d="m20.84 4.61-.07-.06a5.5 5.5 0 0 0-7.78 0L12 5.55l-.99-1A5.5 5.5 0 0 0 3 12.34l1 1L12 21.5l8-8.16 1-1a5.5 5.5 0 0 0-.16-7.73Z"/>,
    ...
    alertTri: <><path d="m10.29 3.86-8.05 13.94A2 2 0 0 0 3.97 21h16.06a2 2 0 0 0 1.73-3.2L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/></>,
    clock: <><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></>,
    flask: <><path d="M10 2v8a4 4 0 1 1-4 4"/><path d="M14 4h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V18"/><path d="M14 4V2"/></>,
    steth: <><path d="M6 2v6a4 4 0 1 0 8 0V2"/><path d="M10 12v3a4 4 0 0 0 4 4h0a4 4 0 0 0 4-4v-2"/><circle cx="18" cy="13" r="2"/></>,
    sparkle: <><path d="m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></>,
    ...
    sort: <><path d="M3 6h13"/><path d="M3 12h9"/><path d="M3 18h6"/><path d="M19 9v9"/><polyline points="22 12 19 9 16 12"/></>,
    filter: <polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/>,
    user: <><circle cx="12" cy="8" r="4"/><path d="M6 21a6 6 0 0 1 12 0"/></>,
    building: <><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22V12h6v10"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M8 10h.01"/><path d="M16 10h.01"/></>,
